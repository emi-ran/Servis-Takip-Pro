...
2. **Schema Tanımlama**: [DATABASE_DESIGN.md](file:///c:/Users/emiran/Desktop/Servis%20Takip/DATABASE_DESIGN.md) dosyasına birebir sadık kalınarak `schema.prisma` dosyasının oluşturulması (Tablolar, Enum'lar ve İlişkiler).
